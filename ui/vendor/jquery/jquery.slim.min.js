...
!(function (e, t) {
  ...
  var p = (function (n) {
    var e,
      ...
      Y = /HTML$/i,
      G = /^(?:input|select|texactividad|button)$/i,
      K = /^h\d$/i,
      J = /^[^{]+\{\s*\[native \w/,
      Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
      ee = /[+~]/,
  ...
  (le = w.createDocumentFragment().appendChild(w.createElement("div"))),
    ...
    (le.innerHTML = "<texactividad>x</texactividad>"),
  ...
  var tt = /^(?:input|select|texactividad|button)$/i,
    nt = /^(?:a|area)$/i;
  function rt(e) {
  ...
  var lt,
    ...
    pt = /^(?:input|select|texactividad|keygen)/i;
  function ht(n, e, r, i) {
    var t;
    if (Array.isArray(e))
      E.each(e, function (e, t) {
