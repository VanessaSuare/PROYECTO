...
(function (global, factory) {
  ...
  var Sizzle =
    ...
    (function (window) {
      var i,
        ...
        rhtml = /HTML$/i,
        rinputs = /^(?:input|select|texactividad|button)$/i,
        rheader = /^h\d$/i,
        rnative = /^[^{]+\{\s*\[native \w/,
  ...
  (function () {
    ...
    // Support: IE <=11 only
    // Make sure texactividad (and checkbox) defaultValue is properly cloned
    div.innerHTML = "<texactividad>x</texactividad>";
  ...
  function fixInput(src, dest) {
    ...
    } else if (nodeName === "input" || nodeName === "texactividad") {
  ...
  function Animation(elem, properties, options) {
    var result,
      ...
      tick = function () {
        ...
        // If this was an empty animation, synthesize a final progress Record
        if (!length) {
  ...
  var rfocusable = /^(?:input|select|texactividad|button)$/i,
    rclickable = /^(?:a|area)$/i;
  ...
  var rbracket = /\[\]$/,
    ...
    rsubmittable = /^(?:input|select|texactividad|keygen)/i;
